...
Compared to something like traditional UML diagrams, this approach felt… *human*.  
...
Instead of just documenting architecture after the fact, **this sketch became a part of shaping it**.
