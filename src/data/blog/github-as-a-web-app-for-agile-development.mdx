...
3. Source code management per target environment and CI/CD per target environment (whether it be the famous three-tier environment scheme — dev, stage, prod — or a monolithic scheme).
